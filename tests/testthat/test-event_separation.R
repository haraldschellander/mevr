...
# Test 1: Basic functionality with standard separation_in_min and time_resolution
test_that("event_separation identifies events correctly based on separation and time resolution", {
  result <- event_separation(mock_data, separation_in_min = 360, time_resolution = 10, ignore_event_duration = 30, min_rain = 0.1)
...
test_that("event_separation handles datasets with no rainfall events", {
  ...
  result <- event_separation(no_rain_data, separation_in_min = 360, time_resolution = 10, ignore_event_duration = 30, min_rain = 0.1)
...
test_that("event_separation detects continuous rainfall as a single event", {
  ...
  result <- event_separation(continuous_rain_data, separation_in_min = 360, time_resolution = 10, ignore_event_duration = 30, min_rain = 0.1)
...
test_that("event_separation correctly applies minimum rainfall threshold", {
  ...
  result <- event_separation(mixed_rain_data, separation_in_min = 360, time_resolution = 10, ignore_event_duration = 30, min_rain = 0.1)
...
test_that("event_separation works correctly with different time resolutions", {
  result_5min <- event_separation(mock_data, separation_in_min = 360, time_resolution = 5, ignore_event_duration = 30, min_rain = 0.1)
  result_30min <- event_separation(mock_data, separation_in_min = 360, time_resolution = 30, ignore_event_duration = 30, min_rain = 0.1)
...
test_that("event_separation ignores events shorter than ignore_event_duration", {
  ...
  result <- event_separation(short_events_data, separation_in_min = 360, time_resolution = 10, ignore_event_duration = 30, min_rain = 0.1)
